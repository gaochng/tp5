<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"E:\php\tp5demo\public/../application/admin\view\admin\edit.html";i:1510202590;s:66:"E:\php\tp5demo\public/../application/admin\view\common\layout.html";i:1510053665;s:66:"E:\php\tp5demo\public/../application/admin\view\common\header.html";i:1510041876;s:64:"E:\php\tp5demo\public/../application/admin\view\common\left.html";i:1510209256;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="utf-8">
                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" id="username" placeholder="" value="<?php echo $data['username']; ?>" name="username" required="" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <p class="help-block col-sm-4 red">* 不填代表不修改</p>
                                </div>
                                <div class="form-group">
