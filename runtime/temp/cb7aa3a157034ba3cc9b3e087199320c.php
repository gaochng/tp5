<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"E:\php\tp5demo\public/../application/admin\view\links\index.html";i:1510210185;s:66:"E:\php\tp5demo\public/../application/admin\view\common\layout.html";i:1510053665;s:66:"E:\php\tp5demo\public/../application/admin\view\common\header.html";i:1510041876;s:64:"E:\php\tp5demo\public/../application/admin\view\common\left.html";i:1510447175;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="utf-8">
...
<button type="button" tooltip="添加友情链接" class="btn btn-sm btn-azure btn-addon" onClick="addAdmin()"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" style="width: 40%;">介绍</th>
...
<script>
    function addAdmin() {
       window.location.href = "<?php echo url('links/add'); ?>";
    }
