<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"E:\php\tp5demo\public/../application/admin\view\links\edit.html";i:1510213436;s:66:"E:\php\tp5demo\public/../application/admin\view\common\layout.html";i:1510053665;s:66:"E:\php\tp5demo\public/../application/admin\view\common\header.html";i:1510041876;s:64:"E:\php\tp5demo\public/../application/admin\view\common\left.html";i:1510209256;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="utf-8">
...
<div class="page-content">
    ...
    <div class="page-breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li>
                <a href="<?php echo url('index'); ?>">友情链接管理</a>
            </li>
                        ...
                        <div id="horizontal-form">
                            <form class="form-horizontal" role="form" action="" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" placeholder="" name="title" value="<?php echo $data['title']; ?>" required="" type="text">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" placeholder="" name="url" value="<?php echo $data['url']; ?>" required="" type="text">
                                    </div>
                                        <p class="help-block col-sm-4 red">* 必填</p>
                                </div>

                                <div class="form-group">
                                    <label  class="col-sm-2 control-label no-padding-right">desc</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" placeholder="" name="desc" value="<?php echo $data['desc']; ?>" type="text">
                                    </div>
                                        <p class="help-block col-sm-4 red">* 必填</p>
                                </div>
