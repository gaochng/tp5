<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:63:"E:\php\tp5demo\public/../application/admin\view\cate\index.html";i:1510447109;s:66:"E:\php\tp5demo\public/../application/admin\view\common\layout.html";i:1510053665;s:66:"E:\php\tp5demo\public/../application/admin\view\common\header.html";i:1510041876;s:64:"E:\php\tp5demo\public/../application/admin\view\common\left.html";i:1510467257;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
    <meta charset="utf-8">
...
<button type="button" tooltip="添加栏目" class="btn btn-sm btn-azure btn-addon" onClick="addAdmin()"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" style="width: 55%;">名称</th>
...
<script>
    function addAdmin() {
       window.location.href = "<?php echo url('cate/add'); ?>";
    }
